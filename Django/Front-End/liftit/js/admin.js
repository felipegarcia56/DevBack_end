function loadTables(){
	...
	$.when(trademarks,bodywork,type_vehicle).done(function(response_tm,response_bw,response_tv){
		...
		var table_tm =create_table("table_tm",headers_tm,response_tm[0]);
		var table_bw =create_table("table_bw",headers_bw,response_bw[0]);
		var table_tv =create_table("table_tv",headers_tv,response_tv[0]);
